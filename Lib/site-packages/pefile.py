...
DIRECTORY_ENTRY = dict([(e[1], e[0]) for e in directory_entry_types] +
                       directory_entry_types)

image_characteristics = [('IMAGE_FILE_RELOCS_STRIPPED', 0x0001),
...
IMAGE_CHARACTERISTICS = dict([(e[1], e[0]) for e in image_characteristics] +
...
SECTION_CHARACTERISTICS = dict([(e[1], e[0])
                                for e in section_characteristics] +
                               section_characteristics)

debug_types = [('IMAGE_DEBUG_TYPE_UNKNOWN', 0), ('IMAGE_DEBUG_TYPE_COFF', 1),
               ('IMAGE_DEBUG_TYPE_CODEVIEW', 2), ('IMAGE_DEBUG_TYPE_FPO', 3),
               ('IMAGE_DEBUG_TYPE_MISC', 4), ('IMAGE_DEBUG_TYPE_EXCEPTION', 5),
               ...
               ('IMAGE_DEBUG_TYPE_POGO', 13), ('IMAGE_DEBUG_TYPE_ILTCG', 14),
...
subsystem_types = [('IMAGE_SUBSYSTEM_UNKNOWN', 0), ('IMAGE_SUBSYSTEM_NATIVE',
                   ...
                   ('IMAGE_SUBSYSTEM_EFI_ROM', 13), ('IMAGE_SUBSYSTEM_XBOX',
                                                     14),
                   ('IMAGE_SUBSYSTEM_WINDOWS_BOOT_APPLICATION', 16)]

SUBSYSTEM_TYPE = dict([(e[1], e[0])
                       for e in subsystem_types] + subsystem_types)
...
relocation_types = [('IMAGE_REL_BASED_ABSOLUTE', 0), ('IMAGE_REL_BASED_HIGH',
                                                      1),
                    ('IMAGE_REL_BASED_LOW', 2), ('IMAGE_REL_BASED_HIGHLOW', 3),
                    ('IMAGE_REL_BASED_HIGHADJ', 4),
                    ('IMAGE_REL_BASED_MIPS_JMPADDR', 5),
                    ('IMAGE_REL_BASED_SECTION', 6), ('IMAGE_REL_BASED_REL', 7),
                    ('IMAGE_REL_BASED_MIPS_JMPADDR16', 9),
                    ('IMAGE_REL_BASED_IA64_IMM64', 9),
                    ('IMAGE_REL_BASED_DIR64', 10),
                    ('IMAGE_REL_BASED_HIGH3ADJ', 11)]

RELOCATION_TYPE = dict([(e[1], e[0])
                        for e in relocation_types] + relocation_types)
...
DLL_CHARACTERISTICS = dict([(e[1], e[0]) for e in dll_characteristics] +
                           dll_characteristics)
...
lang = [
    ...
    ('LANG_ALBANIAN', 0x1c), ('LANG_ARABIC', 0x01), ('LANG_ARMENIAN', 0x2b),
    ('LANG_ASSAMESE', 0x4d), ('LANG_AZERI', 0x2c), ('LANG_BASQUE', 0x2d),
    ('LANG_BELARUSIAN', 0x23), ('LANG_BENGALI', 0x45),
    ('LANG_BULGARIAN', 0x02), ('LANG_CATALAN', 0x03), ('LANG_CHINESE', 0x04),
    ('LANG_CROATIAN', 0x1a), ('LANG_CZECH', 0x05), ('LANG_DANISH', 0x06),
    ('LANG_DIVEHI', 0x65), ('LANG_DUTCH', 0x13), ('LANG_ENGLISH', 0x09),
    ('LANG_ESTONIAN', 0x25), ('LANG_FAEROESE', 0x38), ('LANG_FARSI', 0x29),
    ('LANG_FINNISH', 0x0b), ('LANG_FRENCH', 0x0c), ('LANG_GALICIAN', 0x56),
    ('LANG_GEORGIAN', 0x37), ('LANG_GERMAN', 0x07), ('LANG_GREEK', 0x08),
    ('LANG_GUJARATI', 0x47), ('LANG_HEBREW', 0x0d), ('LANG_HINDI', 0x39),
    ('LANG_HUNGARIAN', 0x0e), ('LANG_ICELANDIC', 0x0f),
    ('LANG_INDONESIAN', 0x21), ('LANG_ITALIAN', 0x10), ('LANG_JAPANESE', 0x11),
    ('LANG_KANNADA', 0x4b), ('LANG_KASHMIRI', 0x60), ('LANG_KAZAK', 0x3f),
    ('LANG_KONKANI', 0x57), ('LANG_KOREAN', 0x12), ('LANG_KYRGYZ', 0x40),
    ('LANG_LATVIAN', 0x26), ('LANG_LITHUANIAN', 0x27), ('LANG_MACEDONIAN',
                                                        0x2f),
    ('LANG_MALAY', 0x3e), ('LANG_MALAYALAM', 0x4c), ('LANG_MANIPURI', 0x58),
    ('LANG_MARATHI', 0x4e), ('LANG_MONGOLIAN', 0x50), ('LANG_NEPALI', 0x61),
    ('LANG_NORWEGIAN', 0x14), ('LANG_ORIYA', 0x48), ('LANG_POLISH', 0x15),
    ('LANG_PORTUGUESE', 0x16), ('LANG_PUNJABI', 0x46), ('LANG_ROMANIAN', 0x18),
    ('LANG_RUSSIAN', 0x19), ('LANG_SANSKRIT', 0x4f), ('LANG_SERBIAN', 0x1a),
    ('LANG_SINDHI', 0x59), ('LANG_SLOVAK', 0x1b), ('LANG_SLOVENIAN', 0x24),
    ('LANG_SPANISH', 0x0a), ('LANG_SWAHILI', 0x41), ('LANG_SWEDISH', 0x1d),
    ('LANG_SYRIAC', 0x5a), ('LANG_TAMIL', 0x49), ('LANG_TATAR', 0x44),
    ('LANG_TELUGU', 0x4a), ('LANG_THAI', 0x1e), ('LANG_TURKISH', 0x1f),
    ('LANG_UKRAINIAN', 0x22), ('LANG_URDU', 0x20), ('LANG_UZBEK', 0x43),
    ('LANG_VIETNAMESE', 0x2a), ('LANG_GAELIC', 0x3c), ('LANG_MALTESE', 0x3a),
    ('LANG_MAORI', 0x28), ('LANG_RHAETO_ROMANCE', 0x17), ('LANG_SAAMI', 0x3b),
    ('LANG_SORBIAN', 0x2e), ('LANG_SUTU', 0x30), ('LANG_TSONGA', 0x31),
    ('LANG_TSWANA', 0x32), ('LANG_VENDA', 0x33), ('LANG_XHOSA', 0x34),
    ('LANG_ZULU', 0x35), ('LANG_ESPERANTO', 0x8f), ('LANG_WALON', 0x90),
    ('LANG_CORNISH', 0x91), ('LANG_WELSH', 0x92), ('LANG_BRETON', 0x93)
]
...
sublang = [
    ...
    ('SUBLANG_GERMAN_LUXEMBOURG', 0x04), ('SUBLANG_GERMAN_LIECHTENSTEIN',
                                          0x05), ('SUBLANG_ITALIAN', 0x01),
    ('SUBLANG_ITALIAN_SWISS', 0x02), ('SUBLANG_KASHMIRI_SASIA', 0x02),
    ('SUBLANG_KASHMIRI_INDIA', 0x02), ('SUBLANG_KOREAN', 0x01),
    ('SUBLANG_LITHUANIAN', 0x01), ('SUBLANG_MALAY_MALAYSIA', 0x01),
    ('SUBLANG_MALAY_BRUNEI_DARUSSALAM', 0x02), ('SUBLANG_NEPALI_INDIA', 0x02),
    ('SUBLANG_NORWEGIAN_BOKMAL', 0x01), ('SUBLANG_NORWEGIAN_NYNORSK', 0x02),
    ('SUBLANG_PORTUGUESE', 0x02), ('SUBLANG_PORTUGUESE_BRAZILIAN', 0x01),
    ('SUBLANG_SERBIAN_LATIN', 0x02), ('SUBLANG_SERBIAN_CYRILLIC', 0x03),
    ('SUBLANG_SPANISH', 0x01), ('SUBLANG_SPANISH_MEXICAN', 0x02),
    ('SUBLANG_SPANISH_MODERN', 0x03), ('SUBLANG_SPANISH_GUATEMALA', 0x04),
    ('SUBLANG_SPANISH_COSTA_RICA', 0x05), ('SUBLANG_SPANISH_PANAMA', 0x06),
...
def retrieve_flags(flag_dict, flag_filter):
    ...
    return [(f[0], f[1]) for f in list(flag_dict.items())
            if isinstance(f[0], (str, bytes)) and f[0].startswith(flag_filter)]
...
if not PY3:
    ...
    def handler(err):
        ...
        values = [('\\u{0:04x}' if ord(err.object[i]) > 255 else '\\x{0:02x}',
    ...
    import codecs
    codecs.register_error('backslashreplace_',
...
class Structure(object):
            ...
            if ',' in elm:
                ...
                for elm_name in elm_names:
                    if elm_name in self.__keys__:
                        search_list = [
                            x[:len(elm_name)] for x in self.__keys__
                        ]
    ...
    def __repr__(self):
        return '<Structure: %s>' % (' '.join(
            [' '.join(s.split()) for s in self.dump()]))
        ...
        for keys in self.__keys__:
            for key in keys:
                ...
                if isinstance(val, (int, long)):
                    ...
                    val_str = ''.join([
                        chr(i) if
                        (i in printable_bytes) else '\\x{0:02x}'.format(i)
            ...
            for key in keys:
                ...
                if isinstance(val, (int, long)):
                    if key == 'TimeDateStamp' or key == 'dwTimeStamp':
                        try:
                            val = '0x%-8X [%s UTC]' % (
                                val, time.asctime(time.gmtime(val)))
                        except ValueError as e:
...
class SectionStructure(Structure):
    ...
    def __setattr__(self, name, val):
        ...
        if name == 'Characteristics':
            section_flags = retrieve_flags(SECTION_CHARACTERISTICS,
                                           'IMAGE_SCN_')
            ...
            if val:
                self.__dict__['Characteristics'] |= SECTION_CHARACTERISTICS[
                    name]
            else:
                self.__dict__['Characteristics'] ^= SECTION_CHARACTERISTICS[
                    name]
    ...
    def get_rva_from_offset(self, offset):
        return offset - self.pe.adjust_FileAlignment(
            self.PointerToRawData, self.pe.OPTIONAL_HEADER.FileAlignment
    ...
    def get_offset_from_rva(self, rva):
        return (rva - self.pe.adjust_SectionAlignment(
            self.VirtualAddress, self.pe.OPTIONAL_HEADER.SectionAlignment, self
            .pe.OPTIONAL_HEADER.FileAlignment)) + self.pe.adjust_FileAlignment(
                self.PointerToRawData, self.pe.OPTIONAL_HEADER.FileAlignment)
    ...
    def contains_rva(self, rva):
        ...
        if (self.next_section_virtual_address is not None
                and self.next_section_virtual_address > self.VirtualAddress and
...
class ImportData(DataContainer):
    ...
    def __setattr__(self, name, val):
        ...
        # following
        #
        if hasattr(self, 'ordinal') and hasattr(self, 'bound') and hasattr(
                self, 'name'):
            ...
            if name == 'ordinal':
                ...
                if self.name_offset:
                    ...
                    self.pe.set_dword_at_offset(self.ordinal_offset,
                                                (0 << 31) | name_rva)
...
class ExportData(DataContainer):
    ...
    def __setattr__(self, name, val):
        ...
        # following
        #
        if hasattr(self, 'ordinal') and hasattr(self, 'address') and hasattr(
                self, 'forwarder') and hasattr(self, 'name'):
...
if PY3:
    allowed_filename = b(string.ascii_lowercase + string.ascii_uppercase +
                         string.digits + "!#$%&'()-@^_`{}~+,.;=[]")
else:  # Python 2.x
    allowed_filename = b(string.lowercase + string.uppercase + string.digits +
                         b"!#$%&'()-@^_`{}~+,.;=[]")
...
#
if PY3:
    allowed_function_name = b(string.ascii_lowercase + string.ascii_uppercase +
                              string.digits + '_?@$()<>')
else:
    allowed_function_name = b(string.lowercase + string.uppercase +
                              string.digits + b'_?@$()<>')
...
class PE(object):
    ...
    __IMAGE_DOS_HEADER_format__ = ('IMAGE_DOS_HEADER',
                                   ('H,e_magic', 'H,e_cblp', 'H,e_cp',
                                    ...
                                    'H,e_maxalloc', 'H,e_ss', 'H,e_sp',
                                    'H,e_csum', 'H,e_ip', 'H,e_cs',
                                    'H,e_lfarlc', 'H,e_ovno', '8s,e_res',
    ...
    __IMAGE_OPTIONAL_HEADER_format__ = ('IMAGE_OPTIONAL_HEADER', (
        ...
        'I,AddressOfEntryPoint', 'I,BaseOfCode', 'I,BaseOfData', 'I,ImageBase',
        'I,SectionAlignment', 'I,FileAlignment',
        'H,MajorOperatingSystemVersion', 'H,MinorOperatingSystemVersion',
        'H,MajorImageVersion', 'H,MinorImageVersion',
        'H,MajorSubsystemVersion', 'H,MinorSubsystemVersion', 'I,Reserved1',
        'I,SizeOfImage', 'I,SizeOfHeaders', 'I,CheckSum', 'H,Subsystem',
        'H,DllCharacteristics', 'I,SizeOfStackReserve', 'I,SizeOfStackCommit',
        'I,SizeOfHeapReserve', 'I,SizeOfHeapCommit', 'I,LoaderFlags',
        'I,NumberOfRvaAndSizes'))

    __IMAGE_OPTIONAL_HEADER64_format__ = (
        'IMAGE_OPTIONAL_HEADER64',
        ('H,Magic', 'B,MajorLinkerVersion', 'B,MinorLinkerVersion',
         'I,SizeOfCode', 'I,SizeOfInitializedData',
         'I,SizeOfUninitializedData', 'I,AddressOfEntryPoint', 'I,BaseOfCode',
         'Q,ImageBase', 'I,SectionAlignment', 'I,FileAlignment',
         'H,MajorOperatingSystemVersion', 'H,MinorOperatingSystemVersion',
         'H,MajorImageVersion', 'H,MinorImageVersion',
         'H,MajorSubsystemVersion', 'H,MinorSubsystemVersion', 'I,Reserved1',
         'I,SizeOfImage', 'I,SizeOfHeaders', 'I,CheckSum', 'H,Subsystem',
         'H,DllCharacteristics', 'Q,SizeOfStackReserve', 'Q,SizeOfStackCommit',
         'Q,SizeOfHeapReserve', 'Q,SizeOfHeapCommit', 'I,LoaderFlags',
         'I,NumberOfRvaAndSizes'))
    ...
    __IMAGE_SECTION_HEADER_format__ = ('IMAGE_SECTION_HEADER', (
        ...
        'H,NumberOfRelocations', 'H,NumberOfLinenumbers', 'I,Characteristics'))

    __IMAGE_DELAY_IMPORT_DESCRIPTOR_format__ = (
        'IMAGE_DELAY_IMPORT_DESCRIPTOR', ('I,grAttrs', 'I,szName', 'I,phmod',
                                          'I,pIAT', 'I,pINT', 'I,pBoundIAT',
                                          'I,pUnloadIAT', 'I,dwTimeStamp'))
    ...
    __IMAGE_EXPORT_DIRECTORY_format__ = ('IMAGE_EXPORT_DIRECTORY',
                                         ('I,Characteristics',
                                          'I,TimeDateStamp', 'H,MajorVersion',
                                          'H,MinorVersion', 'I,Name', 'I,Base',
                                          'I,NumberOfFunctions',
                                          'I,NumberOfNames',
    ...
    __IMAGE_RESOURCE_DATA_ENTRY_format__ = ('IMAGE_RESOURCE_DATA_ENTRY',
                                            ('I,OffsetToData', 'I,Size',
                                             'I,CodePage', 'I,Reserved'))

    __VS_VERSIONINFO_format__ = ('VS_VERSIONINFO', ('H,Length',
                                                    'H,ValueLength', 'H,Type'))

    __VS_FIXEDFILEINFO_format__ = ('VS_FIXEDFILEINFO',
                                   ('I,Signature', 'I,StrucVersion',
                                    'I,FileVersionMS', 'I,FileVersionLS',
                                    'I,ProductVersionMS', 'I,ProductVersionLS',
                                    'I,FileFlagsMask', 'I,FileFlags',
                                    'I,FileOS', 'I,FileType', 'I,FileSubtype',
                                    'I,FileDateMS', 'I,FileDateLS'))

    __StringFileInfo_format__ = ('StringFileInfo', ('H,Length',
                                                    'H,ValueLength', 'H,Type'))
    ...
    __IMAGE_DEBUG_DIRECTORY_format__ = ('IMAGE_DEBUG_DIRECTORY',
                                        ('I,Characteristics',
                                         'I,TimeDateStamp', 'H,MajorVersion',
                                         'H,MinorVersion', 'I,Type',
                                         'I,SizeOfData', 'I,AddressOfRawData',
                                         'I,PointerToRawData'))
    ...
    __IMAGE_LOAD_CONFIG_DIRECTORY_format__ = (
        ...
        ('I,Size', 'I,TimeDateStamp', 'H,MajorVersion', 'H,MinorVersion',
         ...
         'I,ProcessHeapFlags', 'I,ProcessAffinityMask', 'H,CSDVersion',
         'H,Reserved1', 'I,EditList', 'I,SecurityCookie', 'I,SEHandlerTable',
         'I,SEHandlerCount', 'I,GuardCFCheckFunctionPointer', 'I,Reserved2',
    ...
    __IMAGE_LOAD_CONFIG_DIRECTORY64_format__ = (
        ...
        ('I,Size', 'I,TimeDateStamp', 'H,MajorVersion', 'H,MinorVersion',
         'I,GlobalFlagsClear', 'I,GlobalFlagsSet',
         'I,CriticalSectionDefaultTimeout', 'Q,DeCommitFreeBlockThreshold',
         'Q,DeCommitTotalFreeThreshold', 'Q,LockPrefixTable',
         'Q,MaximumAllocationSize', 'Q,VirtualMemoryThreshold',
         'Q,ProcessAffinityMask', 'I,ProcessHeapFlags', 'H,CSDVersion',
         'H,Reserved1', 'Q,EditList', 'Q,SecurityCookie', 'Q,SEHandlerTable',
         'Q,SEHandlerCount', 'Q,GuardCFCheckFunctionPointer', 'Q,Reserved2',
         'Q,GuardCFFunctionTable', 'Q,GuardCFFunctionCount', 'I,GuardFlags'))

    __IMAGE_BOUND_IMPORT_DESCRIPTOR_format__ = (
        'IMAGE_BOUND_IMPORT_DESCRIPTOR', ('I,TimeDateStamp',
                                          'H,OffsetModuleName',
    ...
    def close(self):
        if (self.__from_file is True and hasattr(self, '__data__')
                and ((isinstance(mmap.mmap, type)
                      and isinstance(self.__data__, mmap.mmap))
    ...
    def __unpack_data__(self, format, data, file_offset):
        ...
        try:
            ...
            self.__warnings.append(
                'Corrupt header "{0}" at file offset {1}. Exception: {2}'.
                format(format[0], file_offset, err))
            return None
    ...
    def __parse__(self, fname, data, fast_load):
        ...
        if fname is not None:
            ...
            try:
                ...
                if hasattr(mmap, 'MAP_PRIVATE'):
                    ...
                    # Windows
                    self.__data__ = mmap.mmap(
                        self.fileno, 0, access=mmap.ACCESS_READ)
                self.__from_file = True
            except IOError as excp:
                exception_msg = '{0}'.format(excp)
                if exception_msg:
                    exception_msg = ': %s' % exception_msg
                raise Exception('Unable to access file \'{0}\'{1}'.format(
                    fname, exception_msg))
            finally:
                if fd is not None:
                    fd.close()
        ...
        if not fast_load:
            for byte, byte_count in Counter(bytearray(self.__data__)).items():
                ...
                if (byte == 0 and 1.0 * byte_count / len(self.__data__) > 0.5
                          ...
                          and 1.0 * byte_count / len(self.__data__) > 0.15):
                    self.__warnings.append((
        ...
        if (0xFFFF & self.NT_HEADERS.Signature) == IMAGE_LE_SIGNATURE:
            raise PEFormatError(
                'Invalid NT Headers signature. Probably a LE file')
        if (0xFFFF & self.NT_HEADERS.Signature) == IMAGE_LX_SIGNATURE:
            raise PEFormatError(
                'Invalid NT Headers signature. Probably a LX file')
        if (0xFFFF & self.NT_HEADERS.Signature) == IMAGE_TE_SIGNATURE:
            raise PEFormatError(
                'Invalid NT Headers signature. Probably a TE file')
        ...
        set_flags(self.FILE_HEADER, self.FILE_HEADER.Characteristics,
                  image_flags)
        ...
        if (self.OPTIONAL_HEADER is None and len(
                self.__data__[optional_header_offset:optional_header_offset +
                              0x200]) >=
        ...
        if self.OPTIONAL_HEADER is not None:
            ...
            if self.OPTIONAL_HEADER.Magic == OPTIONAL_HEADER_MAGIC_PE:
                ...
                self.OPTIONAL_HEADER = self.__unpack_data__(
                    ...
                    self.
                    __data__[optional_header_offset:optional_header_offset +
                             0x200],
                    file_offset=optional_header_offset)
                ...
                if (self.OPTIONAL_HEADER is None
                        and len(self.__data__[optional_header_offset:
                                              optional_header_offset + 0x200])
                        >= MINIMUM_VALID_OPTIONAL_HEADER_RAW_SIZE):
        ...
        set_flags(self.OPTIONAL_HEADER,
        ...
        for i in range(
                int(0x7fffffff & self.OPTIONAL_HEADER.NumberOfRvaAndSizes)):
            ...
            if len(self.__data__) - offset < 8:
                ...
                data = self.__data__[offset:offset +
                                     MAX_ASSUMED_VALID_NUMBER_OF_RVA_AND_SIZES]
        ...
        #
        if self.get_section_by_rva(
                self.OPTIONAL_HEADER.AddressOfEntryPoint) is not None:
    ...
    def parse_rich_header(self):
        ...
        rich_index = self.__data__.find(b'Rich', 0x80,
        ...
        try:
            ...
            data = list(
                struct.unpack('<{0}I'.format(int(len(rich_data) / 4)),
                              rich_data))
            if RICH not in data:
                return None
        ...
        #
        checksum = data[1]
        if (data[0] ^ checksum != DANS or data[2] != checksum
                or data[3] != checksum):
            return None
        ...
        for i in range(int(len(data) / 2)):
            ...
            #
            headervalues += [
                data[2 * i] ^ checksum, data[2 * i + 1] ^ checksum
            ]
        return result
                        ...
                        for st_entry in entry.StringTable:
                            for key, entry in list(st_entry.entries.items()):
                                ...
                                if len(entry) > lengths[1]:
                                    l = entry.decode('utf-8').encode(
                                        'utf-16le')
                                    file_data[offsets[1]:offsets[1] +
                                              lengths[1] * 2] = l[:lengths[1] *
                                                                  2]
                                else:
                                    encoded_data = entry.decode(
                                        'utf-8').encode('utf-16le')
                                    file_data[offsets[1]:offsets[1] +
    ...
    def parse_sections(self, offset):
        ...
        for i in range(self.FILE_HEADER.NumberOfSections):
            ...
            section = SectionStructure(
                self.__IMAGE_SECTION_HEADER_format__, pe=self)
            if not section:
                break
            section_offset = offset + section.sizeof() * i
            section.set_file_offset(section_offset)
            section_data = self.__data__[section_offset:section_offset +
                                         section.sizeof()]
            ...
            if len(section_data) == 0:
                self.__warnings.append(
                    'Invalid section {0}. No data in the file (is this corkami\'s virtsectblXP?).'
                    .format(i))
                break
            section.__unpack__(section_data)
            self.__structures__.append(section)

            if section.SizeOfRawData + section.PointerToRawData > len(
                    self.__data__):
            ...
            if self.adjust_FileAlignment(
                ...
                simultaneous_errors += 1
                self.__warnings.append(
                    'Error parsing section {0}. PointerToRawData points beyond the end of the file.'
                    .format(i))

            if section.Misc_VirtualSize > 0x10000000:
                simultaneous_errors += 1
                self.__warnings.append(
                    'Suspicious value found parsing section {0}. VirtualSize is extremely large > 256MiB.'
                    .format(i))

            if self.adjust_SectionAlignment(
                    section.VirtualAddress,
                    self.OPTIONAL_HEADER.SectionAlignment,
                    self.OPTIONAL_HEADER.FileAlignment) > 0x10000000:
                simultaneous_errors += 1
                self.__warnings.append(
                    'Suspicious value found parsing section {0}. VirtualAddress is beyond 0x10000000.'
                    .format(i))
        ...
        for idx, section in enumerate(self.sections):
            if idx == len(self.sections) - 1:
                ...
                section.next_section_virtual_address = self.sections[
                    idx + 1].VirtualAddress

        if self.FILE_HEADER.NumberOfSections > 0 and self.sections:
            return offset + self.sections[0].sizeof(
    ...
    def parse_data_directories(self,
        ...
        directory_parsing = (('IMAGE_DIRECTORY_ENTRY_IMPORT',
        ...
        for entry in directory_parsing:
            ...
            if directories is None or directory_index in directories:
                ...
                if dir_entry.VirtualAddress:
                    if forwarded_exports_only and entry[
                            0] == 'IMAGE_DIRECTORY_ENTRY_EXPORT':
                        value = entry[1](
                            dir_entry.VirtualAddress,
                            dir_entry.Size,
                            forwarded_only=True)
                    elif import_dllnames_only and entry[
            ...
            if (directories is not None) and isinstance(
                    directories, list) and (entry[0] in directories):
        ...
        while True:
            ...
            if section is None:
                ...
                if sections_after_offset:
                    ...
                    section = self.get_section_by_offset(
                        first_section_after_offset)
                    if section is not None:
                        safety_boundary = section.PointerToRawData - file_offset
            else:
                safety_boundary = (section.PointerToRawData + len(
                    section.get_data()) - file_offset)
            if not section:
                self.__warnings.append(
            ...
            for idx in range(
                    min(bnd_descr.NumberOfModuleForwarderRefs,
    ...
    def parse_directory_tls(self, rva, size):
        ...
        try:
            tls_struct = self.__unpack_data__(
                format,
                self.get_data(rva,
                              Structure(format).sizeof()),
                file_offset=self.get_offset_from_rva(rva))
        except PEFormatError:
            self.__warnings.append('Invalid TLS information. Can\'t read '
    ...
    def parse_debug_directory(self, rva, size):
        ...
        for idx in range(int(size / dbg_size)):
            ...
            if dbg.Type == 1:
                ...
                dbg_type_data = self.__data__[dbg_type_offset:dbg_type_offset +
                                              dbg_type_size]
                ...
                if dbg_type_data[:4] == b'RSDS':
                    ...
                    dbg_type = self.__unpack_data__(__CV_INFO_PDB70_format__,
                                                    dbg_type_data,
                                                    dbg_type_offset)
                    ...
                    __CV_INFO_PDB20_format__ = [
                        'CV_INFO_PDB20',
                        [
                            'I,CvHeaderSignature', 'I,CvHeaderOffset',
                            'I,Signature', 'I,Age'
                        ]
                    ]
                    pdbFileName_size = (
                    ...
                    if pdbFileName_size > 0:
                        ...
                        __CV_INFO_PDB20_format__[1].append(
                            '{0}s,PdbFileName'.format(pdbFileName_size))
                    dbg_type = self.__unpack_data__(__CV_INFO_PDB20_format__,
                                                    dbg_type_data,
                                                    dbg_type_offset)
                ...
                ___IMAGE_DEBUG_MISC_format__ = [
                    'IMAGE_DEBUG_MISC',
                    [
                        'I,DataType', 'I,Length', 'B,Unicode', 'B,Reserved1',
                        'H,Reserved2'
                    ]
                ]
                dbg_type_partial = self.__unpack_data__(
                    ___IMAGE_DEBUG_MISC_format__, dbg_type_data,
                    dbg_type_offset)
    ...
    def parse_resources_directory(self,
                                  rva,
                                  size=0,
                                  base_rva=None,
                                  level=0,
        ...
        try:
            ...
            data = self.get_data(
                rva,
                Structure(self.__IMAGE_RESOURCE_DIRECTORY_format__).sizeof())
        except PEFormatError as e:
            self.__warnings.append('Invalid resources directory. Can\'t read '
        ...
        if resource_dir is None:
            ...
            # This directory does not necessarily have to be valid to
            # still have a valid PE file
            self.__warnings.append('Invalid resources directory. Can\'t parse '
                                   'directory data at RVA: 0x%x' % rva)
            return None
        ...
        if number_of_entries > MAX_ALLOWED_ENTRIES:
            self.__warnings.append('Error parsing the resources directory. '
        ...
        for idx in range(number_of_entries):
            ...
            if not name_is_string:
                ...
                try:
                    entry_name = UnicodeStringWrapperPostProcessor(
                        self, ustr_offset)
            ...
            if res.DataIsDirectory:
                    ...
                    for resource_id in entry_directory.entries:
                        if hasattr(resource_id, 'directory'):
                            ...
                            for resource_lang in resource_id.directory.entries:
                                ...
                                if (resource_lang is None
                                        or not hasattr(resource_lang, 'data')
                                        or
                                        resource_lang.data.struct.Size is None
                                ...
                                parse_strings(string_entry_data,
                ...
                struct = self.parse_resource_data_entry(base_rva +
                                                        res.OffsetToDirectory)
            ...
            if level == 0 and res.Id == RESOURCE_TYPE['RT_VERSION']:
                ...
                try:
                    rt_version_struct = last_entry.directory.entries[
                        0].directory.entries[0].data.struct
                except:
    ...
    def parse_resource_data_entry(self, rva):
        ...
        try:
            ...
            data = self.get_data(
                rva,
                Structure(self.__IMAGE_RESOURCE_DATA_ENTRY_format__).sizeof())
        except PEFormatError as excp:
            self.__warnings.append(
    ...
    def parse_resource_entry(self, rva):
        ...
        try:
            data = self.get_data(
                rva,
                Structure(
                    self.__IMAGE_RESOURCE_DIRECTORY_ENTRY_format__).sizeof())
        except PEFormatError as excp:
    ...
    def parse_version_information(self, version_struct):
        ...
        raw_data = self.__data__[start_offset:start_offset +
                                 version_struct.Size]
        ...
        # be invalid
        if (versioninfo_string is not None
                and versioninfo_string != b'VS_VERSION_INFO'):
        ...
        while True:
            ...
            ustr_offset = (version_struct.OffsetToData + stringfileinfo_offset
            ...
            if stringfileinfo_string and stringfileinfo_string.startswith(
                ...
                if stringfileinfo_struct.Type in (
                        0, 1) and stringfileinfo_struct.ValueLength == 0:
                    ...
                    while True:
                        ...
                        ustr_offset = (
                            version_struct.OffsetToData + stringtable_offset +
                            stringtable_struct.sizeof())
                        try:
                            stringtable_string = self.get_string_u_at_rva(
                                ustr_offset)
                        except PEFormatError as excp:
                            self.__warnings.append(
                                'Error parsing the version information, '
                        ...
                        stringfileinfo_struct.StringTable.append(
                            stringtable_struct)
                        ...
                        while entry_offset < stringtable_offset + stringtable_struct.Length:
                            ...
                            try:
                                ...
                                value_offset = self.get_offset_from_rva(
                                    ustr_offset)
                            except PEFormatError as excp:
                                self.__warnings.append(
                                    'Error parsing the version information, '
                                    'attempting to read StringTable Value string. '
                                    'Can\'t read unicode string at offset 0x{0:x}'
                                    .format(ustr_offset))
                                break
            ...
            # Parse a VarFileInfo entry
                ...
                if varfileinfo_struct.Type in (
                        0, 1) and varfileinfo_struct.ValueLength == 0:
                    ...
                    while True:
                        ...
                        varword_offset = self.dword_align(
                            2 * (len(var_string) + 1) + var_offset +
                            var_struct.sizeof(), version_struct.OffsetToData)
                        ...
                        while varword_offset < orig_varword_offset + var_struct.ValueLength:
                            ...
                            word2 = self.get_word_from_data(
                                raw_data[varword_offset + 2:varword_offset +
                                         4], 0)
                            varword_offset += 4

                            if isinstance(word1, int) and isinstance(
                                    word2, int):
                                var_struct.entry = {
                                    var_string:
                                    '0x%04x 0x%04x' % (word1, word2)
                                }

                        var_offset = self.dword_align(
                            var_offset + var_struct.Length,
                            version_struct.OffsetToData)
    ...
    def parse_export_directory(self, rva, size, forwarded_only=False):
        ...
        try:
            export_dir = self.__unpack_data__(
                ...
                self.get_data(
                    rva,
                    Structure(
                        self.__IMAGE_EXPORT_DIRECTORY_format__).sizeof()),
                file_offset=self.get_offset_from_rva(rva))
        except PEFormatError:
            self.__warnings.append(
        ...
        if section:
            safety_boundary = (section.VirtualAddress + len(section.get_data())
                               - export_dir.AddressOfNames)

        symbol_counter = Counter()
        export_parsing_loop_completed_normally = True
        for i in range(
                min(export_dir.NumberOfNames, int(safety_boundary / 4))):
            symbol_ordinal = self.get_word_from_data(address_of_name_ordinals,
                                                     i)

            if (symbol_ordinal is not None
                    and symbol_ordinal * 4 < len(address_of_functions)):
            ...
            if not is_valid_function_name(symbol_name):
                ...
                break
            try:
                symbol_name_offset = self.get_offset_from_rva(
                    symbol_name_address)
            except PEFormatError:
                max_failed_entries_before_giving_up -= 1
                if max_failed_entries_before_giving_up <= 0:
        ...
        export_parsing_loop_completed_normally = True
        for idx in range(
                min(export_dir.NumberOfFunctions, int(safety_boundary / 4))):
    ...
    def parse_delay_import_directory(self, rva, size):
        ...
        while True:
            try:
                ...
                data = self.get_data(
                    rva,
                    Structure(self.__IMAGE_DELAY_IMPORT_DESCRIPTOR_format__).
                    sizeof())
            except PEFormatError as e:
                self.__warnings.append(
                    'Error parsing the Delay import directory at RVA: 0x%x' %
                    (rva))
                break
            ...
            if dll:
                for symbol in import_data:
                    if symbol.name is None:
                        funcname = ordlookup.ordLookup(dll.lower(),
                                                       symbol.ordinal)
                        if funcname:
                            symbol.name = funcname
                import_descs.append(
                    ImportDescData(
                        struct=import_desc, imports=import_data, dll=dll))
    ...
    def parse_import_directory(self, rva, size, dllnames_only=False):
        ...
        while True:
            ...
            if rva > import_desc.OriginalFirstThunk or rva > import_desc.FirstThunk:
                max_len = max(rva - import_desc.OriginalFirstThunk,
                ...
                for symbol in imp_dll.imports:
                    for suspicious_symbol in suspicious_imports:
                        ...
                        if name.startswith(suspicious_symbol):
                            ...
                            break
                    total_symbols += 1
            if suspicious_imports_count == len(
                    suspicious_imports) and total_symbols < 20:
                self.__warnings.append(
        ...
        for idx in range(len(table)):
            ...
            if table[idx].AddressOfData:
                ...
                if table[idx].AddressOfData & ordinal_flag:
                    ...
                    try:
                        hint_name_table_rva = table[
                            idx].AddressOfData & address_mask
            ...
            struct_iat = None
            try:
                if iat and ilt and ilt[idx].AddressOfData != iat[
                        idx].AddressOfData:
    ...
    def get_import_table(self, rva, max_length=None):
        ...
        while True and rva:
            ...
            if (addresses_of_data_set_32 and max(addresses_of_data_set_32) -
                    min(addresses_of_data_set_32) > MAX_ADDRESS_SPREAD):
                return []
            if (addresses_of_data_set_64 and max(addresses_of_data_set_64) -
                    min(addresses_of_data_set_64) > MAX_ADDRESS_SPREAD):
                return []
            ...
            if failed or len(data) != Structure(format).sizeof():
                self.__warnings.append('Error parsing the import table. '
            ...
            if thunk_data and thunk_data.AddressOfData:
                ...
                # and if it looks like it should be an RVA
                    ...
                    if (thunk_data.AddressOfData in addresses_of_data_set_32
                            or thunk_data.AddressOfData in
    ...
    def get_memory_mapped_image(self,
                                max_virtual_address=0x10000000,
                                ImageBase=None):
        ...
        for section in self.sections:
            ...
            VirtualAddress_adj = self.adjust_SectionAlignment(
                section.VirtualAddress, self.OPTIONAL_HEADER.SectionAlignment,
                self.OPTIONAL_HEADER.FileAlignment)
            ...
            for resource_type in self.DIRECTORY_ENTRY_RESOURCE.entries:
                if hasattr(resource_type, 'directory'):
                    for resource_id in resource_type.directory.entries:
                        if hasattr(resource_id, 'directory'):
                            if hasattr(resource_id.directory, 'strings'
                                       ) and resource_id.directory.strings:
                                for res_string in list(resource_id.directory.
                                                       strings.values()):
    ...
    def get_string_at_rva(self, rva, max_length=MAX_STRING_LENGTH):
        ...
        s = self.get_section_by_rva(rva)
        if not s:
            return self.get_string_from_data(
                0, self.__data__[rva:rva + max_length])
    ...
    def get_string_u_at_rva(self, rva, max_length=2**16, encoding=None):
        ...
        while True:
            ...
            if null_index == -1:
                ...
                if data_length < requested or data_length == max_length:
                    ...
                    data += self.get_data(rva + data_length,
        ...
        uchrs = struct.unpack('<{:d}H'.format(null_index),
                              data[:null_index * 2])
    ...
    def dump_info(self, dump=None, encoding='ascii'):
        ...
        if hasattr(self,
                   'OPTIONAL_HEADER') and self.OPTIONAL_HEADER is not None:
        ...
        if (hasattr(self, 'OPTIONAL_HEADER')
                and hasattr(self.OPTIONAL_HEADER, 'DATA_DIRECTORY')):
            ...
            if hasattr(self, 'FileInfo'):
                for entry in self.FileInfo:
                    ...
                    if hasattr(entry, 'StringTable'):
                        for st_entry in entry.StringTable:
                            [
                                dump.add_line(u'  ' + line)
                                for line in st_entry.dump()
                            ]
                            dump.add_line(u'  LangID: {0}'.format(
                                st_entry.LangID.decode(encoding,
                                                       'backslashreplace_')))
                            dump.add_newline()
                            for str_entry in sorted(
                                    list(st_entry.entries.items())):
                                # try:
                ...
                for symbol in module.imports:
                    if symbol.import_by_ordinal is True:
                        if symbol.name is not None:
                            dump.add(
                                '{0}.{1} Ordinal[{2}] (Imported by Ordinal)'.
                                format(
                                    module.dll.decode('utf-8'),
                                    symbol.name.decode('utf-8'),
                                    symbol.ordinal))
                        else:
                            dump.add('{0} Ordinal[{1}] (Imported by Ordinal)'.
                                     format(
                                         module.dll.decode('utf-8'),
                                         symbol.ordinal))
                    else:
        ...
        if hasattr(self, 'DIRECTORY_ENTRY_BOUND_IMPORT'):
            ...
            for bound_imp_desc in self.DIRECTORY_ENTRY_BOUND_IMPORT:
                ...
                for bound_imp_ref in bound_imp_desc.entries:
                    ...
                    dump.add_line(
                        'DLL: {0}'.format(
                            bound_imp_ref.name.decode(encoding,
                                                      'backslashreplace_')), 4)
                    dump.add_newline()
        ...
        if hasattr(self, 'DIRECTORY_ENTRY_RESOURCE'):
            ...
            for resource_type in self.DIRECTORY_ENTRY_RESOURCE.entries:
                ...
                if resource_type.name is not None:
                    ...
                    dump.add_line(
                        u'Name: [{0}]'.format(
                            resource_type.name.decode(encoding,
                                                      'backslashreplace_')), 2)
                else:
                    dump.add_line(
                        u'Id: [0x{0:X}] ({1})'.format(
                ...
                if hasattr(resource_type, 'directory'):
                    ...
                    for resource_id in resource_type.directory.entries:
                        ...
                        if resource_id.name is not None:
                            ...
                            dump.add_line(
                                'Id: [0x{0:X}]'.format(resource_id.struct.Id),
                                6)

                        dump.add_lines(resource_id.struct.dump(), 6)

                        if hasattr(resource_id, 'directory'):
                            dump.add_lines(resource_id.directory.struct.dump(),
                                           8)
                                ...
                                if hasattr(resource_lang, 'data'):
                                    dump.add_line(
                                        ...
                                        (resource_lang.data.lang,
                                         ...
                                         LANG.get(resource_lang.data.lang,
                                                  '*unknown*'),
                                         get_sublang_name_for_lang(
                                             resource_lang.data.lang,
                                             resource_lang.data.sublang)), 8)
                                    dump.add_lines(resource_lang.struct.dump(),
                                                   10)
                                    dump.add_lines(
                                        resource_lang.data.struct.dump(), 12)
                            if hasattr(resource_id.directory, 'strings'
                                       ) and resource_id.directory.strings:
        ...
        if hasattr(self, 'DIRECTORY_ENTRY_DEBUG'):
            ...
            for dbg in self.DIRECTORY_ENTRY_DEBUG:
                ...
                try:
                    ...
                    dump.add_line('Type: 0x{0:x}(Unknown)'.format(
                        dbg.struct.Type))
                dump.add_newline()
                if dbg.entry:
            ...
            for base_reloc in self.DIRECTORY_ENTRY_BASERELOC:
                ...
                for reloc in base_reloc.entries:
                    try:
                        dump.add_line(
                            '%08Xh %s' % (reloc.rva,
                                          RELOCATION_TYPE[reloc.type][16:]), 4)
                    except KeyError:
                        dump.add_line(
                            '0x%08X 0x%x(Unknown)' % (reloc.rva, reloc.type),
                            4)
                dump.add_newline()
    ...
    def dump_dict(self, dump=None):
        ...
        if hasattr(self, 'VS_VERSIONINFO'):
            ...
            dump_dict['Version Information'].append(
                self.VS_VERSIONINFO.dump_dict())

            if hasattr(self, 'VS_FIXEDFILEINFO'):
                dump_dict['Version Information'].append(
                    self.VS_FIXEDFILEINFO.dump_dict())
            ...
            for resource_type in self.DIRECTORY_ENTRY_RESOURCE.entries:
                ...
                if hasattr(resource_type, 'directory'):
                    ...
                    directory_list.append(
                        resource_type.directory.struct.dump_dict())
        ...
        if (hasattr(self, 'DIRECTORY_ENTRY_LOAD_CONFIG')
                ...
                and self.DIRECTORY_ENTRY_LOAD_CONFIG.struct):
            dump_dict[
                'LOAD_CONFIG'] = self.DIRECTORY_ENTRY_LOAD_CONFIG.struct.dump_dict(
                )
        ...
        if hasattr(self, 'DIRECTORY_ENTRY_DEBUG'):
            ...
            for dbg in self.DIRECTORY_ENTRY_DEBUG:
                ...
                dbg_dict['Type'] = DEBUG_TYPE.get(dbg.struct.Type,
                                                  dbg.struct.Type)
    ...
    def set_dword_at_offset(self, offset, dword):
        ...
        return self.set_bytes_at_offset(offset,
                                        self.get_data_from_dword(dword))
    ...
    def set_qword_at_offset(self, offset, qword):
        ...
        return self.set_bytes_at_offset(offset,
                                        self.get_data_from_qword(qword))
    ...
    def set_bytes_at_offset(self, offset, data):
        ...
        if offset >= 0 and offset < len(self.__data__):
            self.__data__ = (self.__data__[:offset] + data +
    ...
    def merge_modified_section_data(self):
        ...
        for section in self.sections:
            ...
            if section_data_start < len(
                    self.__data__) and section_data_end < len(self.__data__):
                self.__data__ = self.__data__[:section_data_start] + section.get_data(
            ...
            for reloc in self.DIRECTORY_ENTRY_BASERELOC:
                ...
                while entry_idx < len(reloc.entries):
                    ...
                    if entry.type == RELOCATION_TYPE[
                        ...
                        self.set_word_at_rva(entry.rva, (self.get_word_at_rva(
                            entry.rva) + relocation_difference >> 16) & 0xffff)
                        ...
                        self.set_word_at_rva(entry.rva, (self.get_word_at_rva(
                            entry.rva) + relocation_difference) & 0xffff)

                    elif entry.type == RELOCATION_TYPE[
                        ...
                        self.set_word_at_rva(
                            ...
                            ((self.get_word_at_rva(entry.rva) << 16) +
                             next_entry.rva + relocation_difference &
                             0xffff0000) >> 16)
    ...
    def generate_checksum(self):
        ...
        for i in range(int(data_len / 4)):
            ...
            if i + 1 == (int(data_len / 4)) and remainder:
                dword = struct.unpack(
                    'I', self.__data__[i * 4:] + (b'\0' * (4 - remainder)))[0]
            else:
    ...
    def is_driver(self):
        ...
        driver_like_section_names = set(('page', 'paged'))
        if driver_like_section_names.intersection([
                section.Name.lower() for section in self.sections
        ]) and (self.OPTIONAL_HEADER.Subsystem in (
    ...
    def get_overlay_data_start_offset(self):
        ...
        def update_if_sum_is_larger_and_within_file(offset_and_size,
                                                    file_size=len(
                                                        self.__data__)):
            if sum(offset_and_size) <= file_size and sum(
                    offset_and_size) > sum(largest_offset_and_size):
        ...
        for idx, directory in enumerate(self.OPTIONAL_HEADER.DATA_DIRECTORY):
            ...
            try:
                largest_offset_and_size = update_if_sum_is_larger_and_within_file(
                    (self.get_offset_from_rva(directory.VirtualAddress),
                     directory.Size))
    ...
    def adjust_FileAlignment(self, val, file_alignment):
        ...
        if file_alignment > FILE_ALIGNMENT_HARDCODED_VALUE:
            ...
            if not power_of_two(
                    file_alignment) and FileAlignment_Warning is False:
                self.__warnings.append(
