...
class DatabaseAPI20Test(unittest.TestCase):
    ...
    def test_paramstyle(self):
        try:
            ...
            # Must be a valid value
            _failUnless(
                self, paramstyle in ('qmark', 'numeric', 'named', 'format',
                                     'pyformat'))
        except AttributeError:
    ...
    def test_Exceptions(self):
        ...
        _failUnless(
            self, issubclass(self.driver.OperationalError, self.driver.Error))
        _failUnless(self,
                    issubclass(self.driver.IntegrityError, self.driver.Error))
        _failUnless(self,
                    issubclass(self.driver.InternalError, self.driver.Error))
        _failUnless(
            self, issubclass(self.driver.ProgrammingError, self.driver.Error))
        _failUnless(
            self, issubclass(self.driver.NotSupportedError, self.driver.Error))
    ...
    def _paraminsert(self, cur):
        ...
        if self.driver.paramstyle == 'qmark':
            ...
            cur.execute(
                ...
                % self.table_prefix, {'beer': "Cooper's"})
