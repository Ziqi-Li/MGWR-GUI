...
class date(object):
    ...
    def __new__(cls, year, month=None, day=None):
        ...
        """
        if (isinstance(year, bytes) and len(year) == 4 and 1 <= year[2] <= 12
                and month is None):  # Month is sane
            # Pickle support
            self = object.__new__(cls)
...
class time(object):
    ...
    def _cmp(self, other, allow_mixed=False):
        ...
        othhmm = other._hour * 60 + other._minute - otoff // timedelta(
            minutes=1)
    ...
    def strftime(self, fmt):
        ...
        timetuple = (1900, 1, 1, self._hour, self._minute, self._second, 0, 1,
                     -1)
...
class datetime(date):
    ...
    def timetuple(self):
        ...
        if dst is None:
            ...
            dst = 0
        return _build_struct_time(self.year, self.month, self.day, self.hour,
                                  self.minute, self.second, dst)
        ...
        if self._tzinfo is None:
            return _time.mktime(
                (self.year, self.month, self.day, self.hour, self.minute,
                 self.second, -1, -1, -1)) + self.microsecond / 1e6
        else:
...
try:
    ...
    del (_DAYNAMES, _DAYS_BEFORE_MONTH, _DAYS_IN_MONTH, _DI100Y, _DI400Y,
         ...
         _call_tzinfo_method, _check_date_fields, _check_time_fields,
         _check_tzinfo_arg, _check_tzname, _check_utc_offset, _cmp, _cmperror,
         _date_class, _days_before_month, _days_before_year, _days_in_month,
         _format_time, _is_leap, _isoweek1monday, _math, _ord2ymd, _time,
         _time_class, _tzinfo_class, _wrap_strftime, _ymd2ord)
